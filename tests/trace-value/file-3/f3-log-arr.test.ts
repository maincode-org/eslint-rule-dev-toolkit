...
describe('Logical expression with simple values tests', () => {
    test('Verifying value of log_arr_001', () => {
        ...
        expect(nodeComponentTrace.traceChildren?.[1].traceChildren?.[0].traceChildren?.[0].traceChildren?.[0].traceChildren?.[1].filename).toBe("file-4");
        ...
        expect(nodeComponentTrace.traceChildren?.[1].traceChildren?.[0].traceChildren?.[0].traceChildren?.[0].traceChildren?.[2].filename).toBe("file-4");
    });
